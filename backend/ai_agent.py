...
def trigger_emergency_call() -> str:
    """
    Initiates an emergency call to the predefined contact number.
    Use this only if the user expresses suicidal ideation, intent to self-harm,
    or describes a mental health emergency requiring immediate help.
    Use this tool only when the user indicates they are in immediate danger or crisis.
    """
    call_emergency()
...
3. `trigger_emergency_call`: Use this immediately if the user expresses suicidal thoughts, self-harm intentions, or is in crisis.
